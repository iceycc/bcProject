<template>
  <div class="warp">
    ...
    <p
      ...
      @click="doAgree">
      <span>我已阅读并同意注册</span>
      <a href="javascript:;" @click.stop="getAgreement('buy')" style=" color:#0096FE;">《郑州银行鼎融易直营银行客户服务协议》、</a>
      <a href="javascript:;" @click.stop="getAgreement('open')" style=" color:#0096FE;">《隐私政策》</a>
    </p>
  </div>
</template>
<script>
